...
Generator.prototype = function(){
    leftWord = function(context){
        return context.leftWords[Math.floor(Math.random() * context.leftWords.length) + 1];
    };

    rightWord = function(context){
        return context.rightWords[Math.floor(Math.random() * context.rightWords.length) + 1];
    };
